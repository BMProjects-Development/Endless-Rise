...
# [Endless Rise: Remastered](https://www.curseforge.com/minecraft/modpacks/endless-rise) — Обновление 1.3.1 "Исправления"
...
<summary>Добавлено</summary>
  1.[Lootjs](https://www.curseforge.com/minecraft/mc-mods/lootjs).
</details>
...
1. Удалён альтернативный способ создания компонента кирпичей для рудной плавильни ( без смешивания которая ), потом надо посмотреть как точно называется
 ```diff
