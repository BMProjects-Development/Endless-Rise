# [Endless Rise: Remastered](https://www.curseforge.com/minecraft/modpacks/endless-rise) — Update 1.3.0 "Fixes"

---

This update focuses on fixing several important issues and overall project improvement. We have fixed many small bugs that interfered with comfortable gameplay, and also generally improved many aspects for smoother and more convenient gameplay.

Key Changes:
1. Returned the "Mods" button to the main menu to allow players to configure mods on their own.
2. Fixed several logical errors in quests.
3. Fixed an issue with duplicate recipes.
4. Improved the modpack's performance.
5. Minor changes in crafts, quests, loot tables, and configs.
...
***Reason for removal:** Other mods already include the functionality of these mods.*
...
1. Short grass from the BYG mod now drops plant fiber, along with vanilla grass.
      ```diff
      {
...
2. Weed grass from the BYG mod now drops plant fiber, along with vanilla grass.
      ```diff
      {
        "type": "minecraft:block",
        "pools": [
...
3. Wilted grass from the BYG mod now drops plant fiber, along with vanilla grass.
      ```diff
      {
        "type": "minecraft:block",
        "pools": [
...
If you have questions, suggestions, or you found a bug - we will be glad to receive your feedback:
...
You can also follow the development and future updates of the modpack there.

If you want to support the development and gain access to bonus content, as well as behind-the-scenes updates:
